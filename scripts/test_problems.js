...
async function run(options = {}) {
  ...
  // Usage 1: node test_problems.js hw1 (test hw1 folder with test-cases.json in hw1)
  // Usage 2: node test_problems.js hw1 hw1_submissions (test hw1_submissions using test-cases.json from hw1)
  // Usage 3: node test_problems.js hw1 hw1_submissions --no-log (skip writing to markdown file)
  ...
  if (!homeworkDir) {
    ...
    console.error('Usage: node test_problems.js <homework_directory> [submissions_directory]');
    console.error('Example: node test_problems.js hw1');
    console.error('Example: node test_problems.js hw1 hw1_submissions');
    process.exitCode = 1;
    return;
  }
  ...
  // CLI options: node test_problems.js homework_dir submissions_dir [p1|p2|p3|all]
